...
public partial class PostgresContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasNoKey().ToView("aircrafts", "bookings");

            entity
                .Property(e => e.AircraftCode)
                .HasMaxLength(3)
                .IsFixedLength()
                .HasComment("Aircraft code, IATA")
                .HasColumnName("aircraft_code");
            entity.Property(e => e.Model).HasComment("Aircraft model").HasColumnName("model");
            entity
                .Property(e => e.Range)
        ...
        modelBuilder.Entity<AircraftsDatum>(entity =>
        {
            ...
            entity.ToTable(
                "aircrafts_data",
                "bookings",
                tb => tb.HasComment("Aircrafts (internal data)")
            );
        ...
        {
            entity.HasNoKey().ToView("airports", "bookings");
            ...
            entity.Property(e => e.City).HasComment("City").HasColumnName("city");
            entity
        ...
        modelBuilder.Entity<AirportsDatum>(entity =>
        {
            ...
            entity.ToTable(
                "airports_data",
                "bookings",
                tb => tb.HasComment("Airports (internal data)")
            );
        ...
        modelBuilder.Entity<BoardingPass>(entity =>
        {
            ...
            entity.Property(e => e.FlightId).HasComment("Flight ID").HasColumnName("flight_id");
            entity
                .Property(e => e.BoardingNo)
        ...
        modelBuilder.Entity<Booking>(entity =>
        {
            ...
            entity
                .Property(e => e.BookRef)
                .HasMaxLength(6)
                .IsFixedLength()
                .HasComment("Booking number")
                .HasColumnName("book_ref");
            entity.Property(e => e.BookDate).HasComment("Booking date").HasColumnName("book_date");
            entity
        ...
        modelBuilder.Entity<Flight>(entity =>
        {
            ...
            entity
                .HasIndex(
                    e => new { e.FlightNo, e.ScheduledDeparture },
            ...
            entity
                .HasOne(d => d.AircraftCodeNavigation)
            ...
            entity
                .HasOne(d => d.ArrivalAirportNavigation)
            ...
            entity
                .HasOne(d => d.DepartureAirportNavigation)
        ...
        {
            entity.HasNoKey().ToView("flights_v", "bookings");
            ...
            entity
                ...
                .HasColumnName("actual_arrival");
            entity
                .Property(e => e.ActualArrivalLocal)
            ...
            entity
                ...
                .HasColumnName("actual_departure");
            entity
                .Property(e => e.ActualDepartureLocal)
            ...
            entity
                ...
                .HasColumnName("scheduled_arrival");
            entity
                .Property(e => e.ScheduledArrivalLocal)
        ...
        {
            entity.HasNoKey().ToView("routes", "bookings");
